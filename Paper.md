...
To understand how the model translates its internal 2D represenations ($\set {e_i}$) into discrete token predictions, we analyze the geometry of the output landscape.
