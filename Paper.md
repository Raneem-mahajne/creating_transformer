...
Nearly all code including creating the transformer model, training it, and generating all figures and videos was generated by Cursor Agent, all results were validated and checked extensively by the primary authors. The first draft of this paper was written by Claude Opus 4.6; the entirety of the draft was thouroughly rewriten, edited, and revised by the authors for factual accuracy, clarity, and language.
