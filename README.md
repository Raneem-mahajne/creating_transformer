...
All figures are saved to `plus_last_even/plots/` (A4 versions in `plus_last_even/plots/a4/`). Checkpoints are saved every 100 training steps to `plus_last_even/checkpoints/`, enabling visualization at any point during training.
